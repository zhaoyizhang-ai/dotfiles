...
allowed-tools: Read, Write, Edit, Bash(python *), Bash(pdflatex *), Bash(xelatex *), Bash(lualatex *), Bash(bibtex *), Bash(biber *), Bash(chktex *), Bash(latexmk *)
metadata:
  category: academic-writing
  tags: [latex, compilation, pdf, bibtex, chktex, error-detection]
  triggers:
    - compile paper
    - latex compile
    - 编译论文
