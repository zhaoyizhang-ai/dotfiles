...
allowed-tools: Read, Write, Edit, Bash(python *), Bash(latex *), Bash(pdflatex *), Bash(xelatex *), Bash(lualatex *), Bash(chktex *)
metadata:
  category: academic-writing
  tags: [latex, formatting, template, conference, icml, iclr, neurips, aaai, acl]
  triggers:
    - latex formatting
    - paper template
    - conference template
