...
metadata:
  category: research
  tags: [research, literature-review, survey, academic, systematic-review]
  triggers:
    - research
    - literature review
    - survey
...
**Location**: `~/deep-research-output/tools/paper_finder.py`
...
```bash
python ~/deep-research-output/tools/paper_finder.py --mode scrape --config <config.yaml>
python ~/deep-research-output/tools/paper_finder.py --mode download --jsonl <results.jsonl>
python ~/deep-research-output/tools/paper_finder.py --list-venues
```
